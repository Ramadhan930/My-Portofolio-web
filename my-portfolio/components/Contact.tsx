  ...
  return (
    <section className="py-40 px-8 md:px-24 bg-black text-white text-center">
      <motion.div
        ...
        viewport={{ once: true }}
      >
        <p className="font-mono text-xs uppercase tracking-[0.5em] mb-4 text-zinc-500">
        ...
        <div className="flex flex-wrap justify-center gap-8">
          <a href="mailto:ramadhangr00@gmail.com" className="text-sm font-bold border-b border-white pb-1 hover:text-zinc-400 transition-colors">EMAIL</a>
          ...
          <a href="https://www.linkedin.com/in/muhammad-gilang-ramadhan-a79253335/" className="text-sm font-bold border-b border-white pb-1 hover:text-zinc-400 transition-colors">LINKEDIN</a>
        </div>
      </motion.div>
